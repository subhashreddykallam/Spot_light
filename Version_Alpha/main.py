...
while True:
    ...
    #crp_c0 = x1-thresh if x1-thresh > 0 else 720
    ...
    crp_image = cv2.resize(img[crp_r0:crp_r1, crp_c0:crp_c1],(300,280))
    
    cv2.imshow('Spot-Light Footage', crp_image)
